...
from .views import (
    NhapKhoHomeView, NhapKhoListView, TaoPhieuNhapView, SuaPhieuNhapView, XemPhieuView,
    DsDonDatHangNccView, ChiTietDonDatHangView, TaoDonDatHangView, SuaDonDatHangView, DanhSachNccView
)

urlpatterns = [
    # Màn hình chọn nghiệp vụ nhập kho
    path('nhap-kho-home/', NhapKhoHomeView.as_view(), name='nhap_kho_home'),
    
    # Nhập kho (Phiếu nhập)
    path('nhap-kho/danh-sach/', NhapKhoListView.as_view(), name='nhap_kho'),
    ...
    path('don-dat-hang-ncc/sua/', SuaDonDatHangView.as_view(), name='sua_don_dat_hang'),
